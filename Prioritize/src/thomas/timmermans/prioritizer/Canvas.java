...
public class Canvas
{
	...
	private void registerMouseListener() {
			...
			//Invoked when a mouse button has been pressed on a component.
				...
				System.out.println("canvas mouseposition: " + canvas.getMousePosition());
				
				int xPositionMouse = canvas.getMousePosition().x;
				int yPositionMouse = canvas.getMousePosition().y;
				
				for (Block block: Block.getBlockList()) {
					if (xPositionMouse >= block.getX() &&
					    xPositionMouse <= block.getX() + block.getLength() &&
					    yPositionMouse >= block.getY() &&
					    yPositionMouse <= block.getY() + block.getLength()) {
	 ...
	 */
	public void registerMouseMotionListener() {
		canvas.addMouseMotionListener(new MouseMotionListener() {
			...
			//Invoked when a mouse button is pressed on a component and then dragged.
				...
				if (currentBlock != null) {
					...
					setForegroundColor(currentBlock.getColor());
